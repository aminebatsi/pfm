    ...
    */
    public function addColumns(): ?PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ->addColumn('id')
            ->addColumn('Int_Emp_Nss')
            ->addColumn('Int_Par_Id')
            ->addColumn('Int_Debut_formatted', function(Intervention $model) { 
                return Carbon::parse($model->Int_Debut)->format('d/m/Y');
            })
            ->addColumn('Int_Nb_Jours')
    ...
    */
    ...
    public function columns(): array
    {
        return [
            ...
            Column::add()
                ->title('INT DEBUT')
                ->field('Int_Debut_formatted', 'Int_Debut')
                ->searchable()
                ->sortable()
                ->makeInputDatePicker('Int_Debut')
                ->editOnClick(RedirectAuthenticatedUsersController::check_role()),
    ...
    public function actions(): array
    {
       ...
       return [
            ...
            */
               ...
               ->caption('Delete')
               ->class($typebt)
               ->route('intervention.destroy', ['id' => 'id'])
               ->method('delete')
               ->can($action_perm)
        ];
    }
